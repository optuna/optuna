...
- **2022-02-14** Pre-releases of Optuna 3.0 are available! Early adopters may want to upgrade and provide feedback for a smoother transition to the coming full release. You can install a pre-release version by `pip install --pre optuna`. Find the latest one [here](https://github.com/optuna/optuna/releases)
