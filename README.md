...
hyperparameter values (e.g., `classifier` and `svm_c`) through multiple *trials* (`n_trials=100`).
Optuna is a framework designed for the automation and the acceleration of the optimization
*studies*.
