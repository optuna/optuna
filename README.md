...
- **2022-02-14** Pre-releases of Optuna 3.0 are available! Early adopters may want to upgrade and provide feedback for a smoother transition to the coming full release. Find the latest one [here](https://github.com/optuna/optuna/releases). Try `pip install optuna==3.0.0a2`
