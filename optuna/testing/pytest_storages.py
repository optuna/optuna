...
class StorageTestCase:
    def test_create_new_study(self, storage: BaseStorage) -> None:
    ...
    def test_create_new_study_with_name(self, storage: BaseStorage) -> None:
        # Generate unique study_name from the current function name.
        function_name = self.test_create_new_study_with_name.__name__
        study_name = function_name
    ...
    def test_delete_study_after_create_multiple_studies(self, storage: BaseStorage) -> None:
    ...
    def test_get_study_id_from_name_and_get_study_name_from_id(self, storage: BaseStorage) -> None:
        # Generate unique study_name from the current function name.
        function_name = self.test_get_study_id_from_name_and_get_study_name_from_id.__name__
        study_name = function_name
        study_id = storage.create_new_study(
            directions=[StudyDirection.MINIMIZE], study_name=study_name
        )
    ...
    def test_set_and_get_study_directions(self, storage: BaseStorage) -> None:
        for target in [
    ...
    def test_set_and_get_study_user_attrs(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
    ...
    def test_set_and_get_study_user_attrs_for_floats(self, storage: BaseStorage) -> None:
        _test_set_and_get_study_user_attrs_for_floats(storage)

    def test_set_and_get_study_system_attrs(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
    ...
    def test_set_and_get_study_system_attrs_for_floats(self, storage: BaseStorage) -> None:
        _test_set_and_get_study_system_attrs_for_floats(storage)

    def test_study_user_and_system_attrs_confusion(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
        for key, value in EXAMPLE_ATTRS.items():
            storage.set_study_system_attr(study_id, key, value)
        assert storage.get_study_system_attrs(study_id) == EXAMPLE_ATTRS
    ...
    def test_create_new_trial(self, storage: BaseStorage) -> None:
        def _check_trials(
    ...
    def test_get_trial_number_from_id(self, storage: BaseStorage) -> None:
    ...
    def test_set_trial_state_values_for_state(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
    ...
    def test_get_trial_param_and_get_trial_params(self, storage: BaseStorage) -> None:
    ...
    def test_set_trial_param(self, storage: BaseStorage) -> None:
    ...
    def test_set_and_get_trial_param_for_floats(self, storage: BaseStorage) -> None:
    ...
    def test_set_trial_intermediate_value(self, storage: BaseStorage) -> None:
        # Setup test across multiple studies and trials.
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
        trial_id_1 = storage.create_new_trial(study_id)
        trial_id_2 = storage.create_new_trial(study_id)
    ...
    def test_set_trial_intermediate_value_for_floats(self, storage: BaseStorage) -> None:
        _test_set_trial_intermediate_value_for_floats(storage)

    def test_get_trial_user_attrs(self, storage: BaseStorage) -> None:
    ...
    def test_set_trial_user_attr(self, storage: BaseStorage) -> None:
    ...
    def test_get_trial_system_attrs(self, storage: BaseStorage) -> None:
        _, study_to_trials = _setup_studies(storage, n_study=2, n_trial=5, seed=10)
        assert all(
    ...
    def test_set_trial_system_attr(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=[StudyDirection.MINIMIZE])
        trial_id_1 = storage.create_new_trial(study_id)
    ...
    def test_set_and_get_trial_system_attr_for_floats(self, storage: BaseStorage) -> None:
    ...
    def test_get_all_trials_deepcopy_option(self, storage: BaseStorage) -> None:
    ...
    def test_get_all_trials_state_option(self, storage: BaseStorage) -> None:
    ...
    def test_get_all_trials_not_modified(self, storage: BaseStorage) -> None:
        _, study_to_trials = _setup_studies(storage, n_study=2, n_trial=20, seed=48)
    ...
    def test_get_n_trials(self, storage: BaseStorage) -> None:
    ...
    def test_get_n_trials_state_option(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(directions=(StudyDirection.MAXIMIZE,))
        generator = random.Random(51)
    ...
    def test_get_best_trial(
        self, storage: BaseStorage, direction: StudyDirection, values: list[float]
    ) -> None:
    ...
    def test_get_best_trial_for_multi_objective_optimization(self, storage: BaseStorage) -> None:
        study_id = storage.create_new_study(
    ...
    def test_get_trial_id_from_study_id_trial_number(self, storage: BaseStorage) -> None:
