...
class DiscreteUniformDistribution(BaseDistribution):
    ...
    This object is instantiated by :func:`~optuna.trial.Trial.suggest_uniform` with ``step`` argument
    and :func:`~optuna.trial.Trial.suggest_discrete_uniform`, and passed
