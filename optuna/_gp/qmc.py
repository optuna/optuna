...
def sample_from_normal_sobol(dim: int, n_samples: int, seed: int) -> torch.Tensor:
    ...
    sobol_engine: Callable[..., torch.quasirandom.SobolEngine] = torch.quasirandom.SobolEngine
    sobol_samples = sobol_engine(dimension=dim, scramble=True, seed=seed).draw(
