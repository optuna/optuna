...
class WeightsAndBiasesCallback(object):
    ...
    .. note::
        To create W&B Sweeps like panels, set ``as_sweeps=True``. This
        creates a single run for each trial. By default, this is set to :obj:`False`,
        as it adds a lot of overhead in between the trials. The study name is used
        to tag the runs generated by the callback. This allows, filtering all the
        runs generated by the study with ``as_sweeps=True`` set.
    ...
    Example:
        ...
        .. code::
            ...
            wandbc = WeightsAndBiasesCallback(study_name=study.study_name, wandb_kwargs=wandb_kwargs)

            study.optimize(objective, n_trials=10, callbacks=[wandbc])

    Args:
        study_name:
            Study name for which the Callback is being used. This is used for tagging
            run(s) generated during the experiment.
        metric_name:
