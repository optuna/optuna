...
class _OptunaObjective(_BaseTuner):
    ...
    def _postprocess(
        ...
        trial._set_system_attr(_ELAPSED_SECS_KEY, elapsed_secs)
        trial._set_system_attr(_AVERAGE_ITERATION_TIME_KEY, average_iteration_time)
        trial._set_system_attr(_STEP_NAME_KEY, self.step_name)
        trial._set_system_attr(_LGBM_PARAMS_KEY, json.dumps(self.lgbm_params))
