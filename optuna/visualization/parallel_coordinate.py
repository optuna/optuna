...
def plot_parallel_coordinate(study: 'optuna.study.Study', params: Optional[List[str]] = None) -> 'go.Figure':
...
def _get_parallel_coordinate_plot(study: 'optuna.study.Study', params: Optional[List[str]] = None) -> 'go.Figure':
