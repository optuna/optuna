...
class InMemoryStorage(base.BaseStorage):
    ...
    def __init__(self):
        ...
        self.direction = study_direction.StudyDirection.NOT_SET
    ...
    def set_study_direction(self, study_id, direction):
        ...
        with self._lock:
            if self.direction != study_direction.StudyDirection.NOT_SET and self.direction != direction:
                raise ValueError(
    ...
    def _update_cache(self, trial_id):
        ...
        if self.get_study_direction(IN_MEMORY_STORAGE_STUDY_ID) == study_direction.StudyDirection.MAXIMIZE:
