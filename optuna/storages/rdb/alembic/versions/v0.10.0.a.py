...
def upgrade():
    ...
    op.create_table(
        'studies', sa.Column('study_id', sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.CheckConstraint('version_info_id=1'), sa.PrimaryKeyConstraint('version_info_id'))
    ...
    op.create_table('study_user_attributes',
                    ...
                    sa.UniqueConstraint('study_id', 'key'))
    op.create_table(
        'trials', sa.Column('trial_id', sa.Integer(), nullable=False),
        sa.Column('study_id', sa.Integer(), nullable=True),
        sa.Column(
            'state',
            sa.Enum('RUNNING', 'COMPLETE', 'PRUNED', 'FAIL', name='trialstate'),
            nullable=False), sa.Column('value', sa.Float(), nullable=True),
    ...
    op.create_table('trial_params', sa.Column('param_id', sa.Integer(), nullable=False),
    ...
    op.create_table('trial_user_attributes',
                    ...
                    sa.UniqueConstraint('trial_id', 'key'))
    op.create_table('trial_values', sa.Column('trial_value_id', sa.Integer(), nullable=False),
                    sa.Column('trial_id', sa.Integer(), nullable=True),
