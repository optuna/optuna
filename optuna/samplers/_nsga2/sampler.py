...
class NSGAIISampler(BaseSampler):
    ...
    Args:
        ...
        crossover:
            ...
            - uniform: Select each parameter with equal probability from the two parent individuals.
            ...
            - blxalpha: Uniformly sample child individuals from the hyper-rectangles created by the two parent individuals.
            ...
            - sbx: Generate a child from two parent individuals according to the following polynomial probability distribution.
                - `Deb, K. and R. Agrawal.
                “Simulated Binary Crossover for Continuous Search Space.”
                Complex Syst. 9 (1995): n. pag.
                <https://www.complex-systems.com/abstracts/v09_i02_a02/>`_
            - vsbx: In SBX, the probability of occurrence of child individuals becomes zero in some parameter regions.
            ...
            - undx: Generate child individuals from the three parents using a multivariate normal distribution.
            ...
            - undxm: In UNDX, the child is generated only in a limited area of the search range; in UNDX-m, the children are generated in a distribution that covers the search range more densely.
                `H. Kita, I. Ono and S. Kobayashi,
                Multi-parental extension of the unimodal normal distribution crossover
                for real-coded genetic algorithms,
                Proceedings of the 1999 Congress on Evolutionary Computation-CEC99 (Cat. No. 99TH8406),
                1999, pp. 1581-1588 Vol. 2
                <https://ieeexplore.ieee.org/document/782672>`_
            - spx: It uniformly sample child individuals from within a single simplex that is similar to the simplex produced by the parent individual.
