...
import joblibspark #https://github.com/joblib/joblib-spark/pull/21
...
if __name__ == "__main__":
    ...
    joblibspark.register_spark() # register spark backend

    study = optuna.load_study(
        study_name="kubernetes_spark",
    ...
    n_jobs = 4
    with sklearn.utils.parallel_backend('spark', n_jobs=n_jobs):
