...
+----------------------------------+---------------+-------------+-------------+--------------+----------------------------------------+------------+----------------+
| Recommended budgets (#trials)    | as many as one likes | Less than the number of possible combinations | 100 ~ 1000 trials | 1000 ~ 10000 trials | 100 ~ 10000 trials | as many as one likes | 10 ~ 100 trials |
+----------------------------------+---------------+-------------+-------------+--------------+----------------------------------------+------------+----------------+
