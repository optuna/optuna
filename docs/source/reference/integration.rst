...
.. note::
   ...
   `optuna-integration`. The repository is `here <https://github.com/optuna/optuna-integration>`_, and the documentation 
   is `here <https://optuna-integration.readthedocs.io/en/latest/index.html>`_.
