...
def test_tree_get_node_subspaces(tree: _FanovaTree) -> None:
    ...
    numpy.testing.assert_array_equal(
        tree._get_node_left_child_subspaces(0, search_spaces),
        expected_left_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_right_child_subspaces(0, search_spaces),
        expected_right_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_children_subspaces(0, search_spaces)[0],
        expected_left_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_children_subspaces(0, search_spaces)[1],
        expected_right_child_subspace,
    )
    ...
    numpy.testing.assert_array_equal(
        tree._get_node_left_child_subspaces(1, search_spaces),
        expected_left_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_right_child_subspaces(1, search_spaces),
        expected_right_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_children_subspaces(1, search_spaces)[0],
        expected_left_child_subspace,
    )
    numpy.testing.assert_array_equal(
        tree._get_node_children_subspaces(1, search_spaces)[1],
        expected_right_child_subspace,
    )
    numpy.testing.assert_array_equal(search_spaces, search_spaces_copy)
