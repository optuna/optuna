...
def test_successive_halving_pruner_intermediate_values(direction_value):
    ...
    assert not pruner.prune(study._storage, study.study_id, trial._trial_id, step=1)
    ...
    assert pruner.prune(study._storage, study.study_id, trial._trial_id, step=1)
...
def test_successive_halving_pruner_rung_check():
    ...
    for i in range(7):
        ...
        pruner.prune(study._storage, study.study_id, trial._trial_id, step=7)
...
def test_successive_halving_pruner_first_trial_is_not_pruned():
    ...
    for i in range(10):
        ...
        assert not pruner.prune(study._storage, study.study_id, trial._trial_id, step=i)
...
def test_successive_halving_pruner_with_nan():
    ...
    assert pruner.prune(study._storage, study.study_id, trial._trial_id, step=2)
...
def test_successive_halving_pruner_min_resource_parameter():
    ...
    assert not pruner.prune(study._storage, study.study_id, trial._trial_id, step=2)
    assert 'completed_rung_0' in trial.system_attrs
    assert 'completed_rung_1' not in trial.system_attrs
...
def test_successive_halving_pruner_reduction_factor_parameter():
    ...
    assert not pruner.prune(study._storage, study.study_id, trial._trial_id, step=3)
    assert 'completed_rung_1' in trial.system_attrs
    assert 'completed_rung_2' not in trial.system_attrs
